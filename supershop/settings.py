...
SECRET_KEY = 'django-insecure-+c)o-x91*c+4!7um8!$!lpmpg(2=59t)$%!6a1d8gkren@@+#i'
...
# Répertoire où collecter tous les fichiers statiques (utilisé lors du déploiement)
